    ...
    <div class="flex items-start gap-6">
        ...
        <div class="flex-grow">
            <div class="flex justify-between items-start mb-3">
                <div>
                    <h3 class="text-lg font-semibold text-gray-900">{{ $warranty['product_name'] }}</h3>
                    <p class="text-sm text-gray-500">Số Serial: {{ $warranty['serial_number'] }}</p>
                </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <p class="font-medium text-gray-900">{{ $warranty['purchase_date'] }}</p>
                </div>
                <div>
                    <p class="text-sm text-gray-500">Bảo Hành Hết Hạn</p>
                    <p class="font-medium text-gray-900">{{ $warranty['warranty_end'] }}</p>
                </div>
            </div>
        </div>
    </div>
