        ...
        <div class="bg-white border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div class="flex items-start gap-4"> {{-- Giảm gap từ 6 xuống 4 --}}
                ...
                <div class="flex-shrink-0">
                    <div class="w-12 h-12 bg-cyan-100 rounded-lg flex items-center justify-center"> {{-- Giảm size icon
                        xuống 12 --}}
                ...
                <div class="flex-1 min-w-0"> {{-- flex-1 và min-w-0 giúp text truncate hoạt động --}}
                    ...
                    <div class="flex justify-between items-start mb-2"> {{-- Giảm mb xuống 2 --}}
                        ...
                        @php
                            $status = strtoupper($warranty['status'] ?? 'PENDING');
                        ...
                        @endphp
                        <span
                            class="flex-shrink-0 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $statusClass }}">
                            {{ $status }}
                        </span>
