...
<body
    class="min-h-screen bg-gradient-to-br from-cyan-500 via-blue-600 to-purple-700 flex items-center justify-center p-4">

    <div class="w-full max-w-md bg-white/20 backdrop-blur-xl p-10 rounded-3xl shadow-2xl border border-white/30">

        <div class="text-center mb-8">
            <div
                class="mx-auto w-24 h-24 rounded-full bg-white/30 backdrop-blur flex items-center justify-center shadow-lg">
        ...
        <form action="{{ route('admin.login.submit') }}" method="POST" class="space-y-5">
            ...
            <button class="w-full py-3 mt-3 bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 
